...
`OSINT` `Risk Analytics` `AI` `Platform Risk`
...
Compliance-as-Code governance OS for EdTech AI. DPDP Act 2023 §9 ruling engine, cryptographic dual-key sign-off, >99.4% prompt firewall.

`Child Safety` `AI Governance` `DPDP §9` `EdTech`
...
I'm drawn to problems where the answer isn't simply *"what does the policy say?"* — but where you have to trace cause, context, and consequence before you can say anything useful.
